...
class PropertiesProjectIntegrationTest : BaseIntegrationTest() {
    ...
    @Test
    fun `ChangePropertyValue updates a single property`() {
    ...
    @Test
    fun `ChangePropertyValue produces unified diff`() {
    ...
    @Test
    fun `ChangePropertyValue with --dry-run does not modify properties file`() {
        val propsFile = projectDir.resolve("application.properties")
    ...
    @Test
    fun `FindAndReplace also processes properties files`() {
        val propsFile = projectDir.resolve("application.properties")
    ...
    @Test
    fun `ChangePropertyValue processes properties nested in src main resources`() {
