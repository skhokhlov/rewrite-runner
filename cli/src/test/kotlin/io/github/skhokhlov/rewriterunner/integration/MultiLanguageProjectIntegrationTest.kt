...
class MultiLanguageProjectIntegrationTest :
    FunSpec({
        ...
        beforeEach {
            projectDir = Files.createTempDirectory("multilang-it-project-")
            cacheDir = Files.createTempDirectory("multilang-it-cache-")
        }
        ...
        test("files mode lists paths for all changed files without diff markers") {
            createSpringBootProject()
            projectDir.writeFindAndReplaceRecipe(find = "PLACEHOLDER", replace = "REPLACED")
            ...
            assertTrue(
                ...
                "FILES mode must not emit unified diff markers"
            )
        ...
        test("report mode creates json report covering all changed file types") {
            createSpringBootProject()
            projectDir.writeFindAndReplaceRecipe(find = "PLACEHOLDER", replace = "REPLACED")
        ...
        test("dry-run leaves all files unchanged across every supported language") {
            createSpringBootProject()
        ...
        test("AutoFormat targets only java files and ignores all other types") {
            createSpringBootProject()
