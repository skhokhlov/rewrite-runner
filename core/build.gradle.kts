...
dependencies {
    ...
    api(platform("org.openrewrite.recipe:rewrite-recipe-bom:3.30.0"))
    ...
    implementation("org.openrewrite:rewrite-gradle:8.81.5")
    ...
    implementation("org.apache.maven.resolver:maven-resolver-api:2.0.17")
    implementation("org.apache.maven.resolver:maven-resolver-impl:2.0.17")
    implementation("org.apache.maven.resolver:maven-resolver-supplier-mvn3:2.0.17")
