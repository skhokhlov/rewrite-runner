 ...
 *
 * Used by [org.example.recipe.RecipeArtifactResolver] and
 * [org.example.lst.DependencyResolutionStage] when resolving JARs.
 *
 ...
 *   When empty, all [org.example.lst.LstBuilder] default extensions are used.
